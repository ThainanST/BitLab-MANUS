...
const int SERVO_PINS[] = {9, 10, 11, 12, 13};
const int CLOSE_MAX_ANGLE = 170; // Global max close angle adjustment (0-180)
...
AppController app(SERVO_PINS, CLOSE_MAX_ANGLE, FINGER_MOTION);
